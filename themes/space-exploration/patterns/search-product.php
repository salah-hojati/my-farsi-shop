 ...
 * Slug: space-exploration/search-product
 * Categories: space-exploration, search-product
 */
?>
...
<!-- wp:paragraph -->
<p><?php esc_html_e('No products were found matching your selection.','space-exploration'); ?></p>
<!-- /wp:paragraph -->
