 ...
 * Slug: space-exploration/single-product
 * Categories: space-exploration, single-product
 */
?>
...
<h2 class="wp-block-heading has-text-align-left has-large-font-size" style="margin-top:1rem;margin-bottom:1rem"><?php esc_html_e('Related Products','space-exploration'); ?></h2>
<!-- /wp:heading -->
